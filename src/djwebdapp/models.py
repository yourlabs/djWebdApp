...
class Account(models.Model):
    ...
    .. py:attribute:: secret_key
        ...
        Encrypted private key of this account. This is used to sign
        transactions.
        The secret key is set by the :py:meth:`~set_secret_key()` method
        called by the signal receiver `setup` when the account is created.
    ...
    .. py:property:: provider
        ...
        Returns the provider class for this account.

    .. py:method:: refresh_balance()

        Refreshes the balance of this account.

    .. py:method:: set_secret_key(value)

        :param value: The secret key to set. This value is generated by the
            provider class.

        Sets the secret key of this account. This is called by the signal
        receiver `setup` when the account is created.

    .. py:method:: get_secret_key()

        Returns the account secret key converted to binary.
...
class Transaction(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
        Save the transaction in the database and set kind attribute by the
    ...
    def dependency_add(self, transaction):
        ...
        :param transaction: The transaction that must be
