    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secret_key', fernet_fields.fields.EncryptedBinaryField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver', models.ForeignKey(blank=True, help_text='Receiver address, if this is a transfer', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(model_name)s_received', to='djwebdapp.account')),
                ('sender', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='%(model_name)s_sent', to='djwebdapp.account')),
            ],
        ),
        migrations.CreateModel(
            name='Node',
